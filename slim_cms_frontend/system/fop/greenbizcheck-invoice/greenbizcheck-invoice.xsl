...
<xsl:stylesheet 
	...
	<xsl:variable name="head-list">
		<item>
			...
			<value><fo:basic-link external-destination="url('http://www.greenbizcheck.com')" text-decoration="underline" color="rgb(0,0,255)">www.greenbizcheck.com</fo:basic-link></value>
		</item>
		<item>
			<caption>E-mail</caption>
			<value><fo:basic-link external-destination="url('mailto:info@greenbizcheck.com')" text-decoration="underline" color="rgb(0,0,255)">info@greenbizcheck.com</fo:basic-link></value>
		</item>
		<item>
			<caption>Phone</caption>
			<value>
				<fo:block>1300 552 335</fo:block>
			</value>
		</item>
		<item>
			<caption>Address</caption>
			<value>
				<fo:block>GPO BOX 887</fo:block>
				<fo:block>Sydney NSW 2001</fo:block>
			</value>
		</item>
		<item>
	...
	<xsl:variable name="bank-details-au">
		<item>
			<caption>Bank</caption>
			<value>ANZ Bank (Australia)</value>
		</item>
		<item>
			<caption>Account Name</caption>
			<value>GreenBizCheck Operations Pty Ltd</value>
		</item>
		<item>
			<caption>SWIFT</caption>
			<value>ANZBAU3M</value>
		</item>
		<item>
			<caption>BSB</caption>
			<value>014518</value>
		...
		<item>
			<caption>Account Number</caption>
			<value>528045266</value>
		</item>
	</xsl:variable>
	
	<xsl:variable name="bank-details-nz">
		<item>
			<caption>Bank</caption>
			<value>ANZ Bank (New Zealand)</value>
		</item>
		<item>
			<caption>Account Name</caption>
			<value>GreenBizCheck Operations Pty Ltd</value>
		...
		<item>
			<caption>Account Number</caption>
			<value>014219900</value>
		</item>
	</xsl:variable>
	
	<xsl:variable name="bank-details-singapore">
		<item>
			<caption>Bank</caption>
			<value>OCBC BANK (Singapore)</value>
		</item>
		<item>
			<caption>Account Name</caption>
			<value>GREENBIZCHECK SINGAPORE PTE LIMITED</value>
		</item>
		<item>
			<caption>Bank Code</caption>
			<value>7339</value>
		</item>
		<item>
			<caption>Account Number</caption>
			<value>629502543001</value>
		</item>
	</xsl:variable>
			...
			<fo:page-sequence master-reference="all-pages">
				...
				<fo:flow flow-name="xsl-region-body" font-size="12pt" font-family="Helvetica">
					...
					<fo:block-container position="absolute" left="0cm" top="0cm" width="8.5cm" height="5cm" text-align="center">
						<fo:block><fo:external-graphic src="url(greenbizcheck-cloud-logo.png)" content-width="8cm" /></fo:block>
						<fo:block font-size="8pt" width="5.5cm">
							<fo:block>GreenBizCheck Operations Pty Ltd</fo:block>
							<fo:block>ABN 45 141 435 234</fo:block>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container position="absolute" left="0cm" top="6.5cm" width="19cm" border-style="sold">
						...
						<fo:block line-height="12pt" font-size="10pt">
							...
							<fo:block>
								...
								<fo:basic-link external-destination="url('http://www.greenbizcheck.com/pay-your-account/?account_no={$invoice/client/@account_no}')" text-decoration="underline" color="rgb(0,0,255)">by clicking here</fo:basic-link>
								or visit 
							</fo:block>
							<fo:block>
								<fo:basic-link external-destination="url('http://www.greenbizcheck.com/pay-your-account/')" text-decoration="underline" color="rgb(0,0,255)">www.greenbizcheck.com/pay-your-account/</fo:basic-link>
							...
							<fo:block margin-top="10pt" margin-left="1cm">
								<xsl:choose>
									<xsl:when test="$invoice/currency/@code = 'NZD'">
										<xsl:call-template name="display-field-table">
											<xsl:with-param name="list" select="exsl:node-set($bank-details-nz)"/>
											<xsl:with-param name="col1-width" select="'4cm'"/>
											<xsl:with-param name="col2-width" select="'10cm'"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:when test="$invoice/currency/@code = 'SGD'">
										<xsl:call-template name="display-field-table">
											<xsl:with-param name="list" select="exsl:node-set($bank-details-singapore)"/>
											<xsl:with-param name="col1-width" select="'4cm'"/>
											<xsl:with-param name="col2-width" select="'10cm'"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise>
										<xsl:call-template name="display-field-table">
											<xsl:with-param name="list" select="exsl:node-set($bank-details-au)"/>
											<xsl:with-param name="col1-width" select="'4cm'"/>
											<xsl:with-param name="col2-width" select="'10cm'"/>
										</xsl:call-template>
									</xsl:otherwise>
							...
							<fo:block margin-top="6pt">
								Please use your GreenBizCheck account number <fo:inline font-weight="bold"><xsl:value-of select="$invoice/client/@account_no"/></fo:inline> as reference.
							</fo:block>
							<fo:block margin-top="6pt">
								<fo:inline font-weight="bold">Disclaimer: </fo:inline>Please note by payment of this invoice you access GreenBizCheck's terms and conditions and agree not to hold GreenBizCheck or any of its related parties liable for any errors, omissions or any actions taken as a result of any services, reports or advice given.
							</fo:block>
							<fo:block margin-top="6pt">
								Payment or Registration constitutes acceptance of our 
								<fo:basic-link external-destination="url('http://www.greenbizcheck.com/service-agreement')" text-decoration="underline" color="rgb(0,0,255)">service agreement</fo:basic-link>.
							</fo:block>
