<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:include href="questionAnswers.xsl" />
	<xsl:include href="../../plugin/checklist/methods/auslsa-templates.xsl" />
		...
		<fo:root>
			...
			<fo:page-sequence master-reference="cover-page">
				<fo:flow flow-name="xsl-region-body" font-family="Arial">
					...
					<!-- //Cover Page Image -->
					<fo:block-container position="absolute" left="0mm" top="-1mm" width="210mm" height="297mm" overflow="hidden">
						<fo:block>
							<fo:external-graphic src="url(cover-page.jpg)" scaling="non-uniform" content-height="297mm" />
						</fo:block>
					</fo:block-container>

					<!-- //Cover Page Logo -->
					<fo:block-container position="absolute" top="5mm" right="5mm" text-align="right">
						<fo:block>
							<fo:external-graphic src="url(logo.gif)" scaling="non-uniform" content-width="175px" />
						</fo:block>
					</fo:block-container>
			
					
					<fo:block-container position="absolute" top="60mm">
						<fo:block text-align="center" color="#ffffff" font-size="32pt" margin="0mm" font-weight="bold" line-height="50pt">
						...
						<fo:block text-align="center" color="#ffffff" font-size="32pt" margin="0mm" font-weight="bold" line-height="50pt">
							<xsl:value-of select="/config/plugin/report/@date_range_finish_year" />
						</fo:block>
						<fo:block text-align="center" color="#ffffff" font-size="26pt" margin="0mm" margin-top="50px" font-weight="bold" line-height="30pt">
							<xsl:value-of select="$companyName"/>
						</fo:block>
						<fo:block text-align="center" color="#ffffff" font-size="18pt" margin="0mm" font-weight="bold" line-height="30pt">
							Firm Entry and Benchmarking Summary
						</fo:block>
					</fo:block-container>
					
					<!-- //Footer content -->

					<fo:block-container position="absolute" top="275mm">
						<fo:block background-color="#ffffff" padding-left="16px" padding-right="0" padding-top="25px" padding-bottom="25px" margin-left="0px" margin-right="0px">
							
							<fo:block-container> 				
								<fo:block color="#515151">
									<xsl:text>Report created on  </xsl:text>
			...
			<fo:page-sequence master-reference="all-pages">
				...
				<fo:static-content flow-name="xsl-region-before">
					<fo:block-container line-height="10mm" font-size="10pt" font-family="Arial" position="absolute">
						<fo:block text-align="left" color="rgb(255,255,255)" margin-left="10mm">
							<xsl:choose>
								<xsl:when test="/config/plugin/report/@report_name != ''">
									<xsl:value-of select="/config/plugin/report/@report_name"/>
								</xsl:when>
								<xsl:otherwise>
				...
				<fo:static-content flow-name="xsl-region-after">
					...
					<fo:block-container line-height="10mm" font-size="10pt" font-family="Arial" position="absolute">
						<fo:block text-align="left" margin-left="10mm" color="rgb(255,255,255)">
							Report Status: <xsl:value-of select="/config/plugin/report/@status"/>
						</fo:block>
					</fo:block-container>

					<!-- //Publication -->
					<fo:block-container line-height="10mm" font-size="10pt" font-family="Arial" position="absolute">
						<fo:block text-align="center" color="rgb(255,255,255)">
							<xsl:choose>
								<xsl:when test="/config/plugin/report/questionAnswer/answer[@answer_id='33640']">
									For publication
								</xsl:when>
								<xsl:otherwise>
									Not for publication
				...
				<fo:flow flow-name="xsl-region-body" font-size="10pt" font-family="Arial" line-height="1.2em" color="rgb(35,31,32)">
					...
					<xsl:for-each select="/config/plugin[@plugin='checklist']/report[1]/reportSection[@display_in_pdf = '1']">
						...
						<fo:block margin-bottom="20mm" break-before="page">

							<xsl:variable name="background-color">
								<xsl:choose>	
									<xsl:when test="$report/@report_primary_color != ''">
										<xsl:value-of select="$report/@report_primary_color" />
									</xsl:when>
									<xsl:otherwise>
							...
							<xsl:variable name="text-color">
								<xsl:choose>	
									<xsl:when test="$report/@report_secondary_color != ''">
										<xsl:value-of select="$report/@report_secondary_color" />
									</xsl:when>
									<xsl:otherwise>
							...
							<fo:block font-size="18px" font-weight="bold" color="{$text-color}" id="report-section-{@report_section_id}" background-color="{$background-color}" padding="15px"
								margin-left="0mm" margin-right="0mm"
								border-width="1px" border-color="{$border-color}" border-style="solid">
