...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="silver_press_release_email">
		<p><a href="/members/email-templates/">Email Templates</a><xsl:text> &gt; </xsl:text><a href="/members/email-templates/silver-press-release-email/">Silver Press Release Email</a></p>
				<p>
				...
				<p><strong><xsl:value-of select="/config/plugin[@plugin = 'clients']/client/@company_name" /> achieves GreenBizCheck Silver Certification</strong></p>
				<p><xsl:value-of select="/config/plugin[@plugin = 'clients']/client/@company_name" /> is pleased to announce that it has reached GreenBizCheck (<a href="http://www.greenbizcheck.com">www.greenbizcheck.com</a>) silver certification.</p>
