...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="gold_staff_email">
		<p><a href="/members/email-templates/">Email Templates</a><xsl:text> &gt; </xsl:text><a href="/members/email-templates/gold-staff-email/">Gold Staff Notification Email</a></p>
				<p>
					<xsl:text>Hi All</xsl:text>
				</p>
				<p>Our company is very proud to announce that we have reached Bronze GreenBizCheck (<a href="http://www.greenbizcheck.com">www.greenbizcheck.com</a>)environmental certification and we would like to thank all of you for your invaluable contribution.</p>
				<p>Only a very small percentage of all GreenBizCheck clients manage to reach Gold status and we are delighted to have achieved the highest rating possible.</p>
