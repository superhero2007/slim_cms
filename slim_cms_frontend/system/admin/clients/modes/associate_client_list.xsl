...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/config[@mode = 'associate_client_list']">
		...
		<p id="breadcrumb">
			...
			<xsl:text> &gt; </xsl:text>
			<a href="?page=clients&amp;mode=associate_client_list&amp;client_id={$client/@client_id}">Associate Client List</a>
		</p>
		<h1>Associate Clients</h1>
		<table>
			<thead>
				<tr>
