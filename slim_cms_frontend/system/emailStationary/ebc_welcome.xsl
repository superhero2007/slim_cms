			...
			<body>            	
				<table class="background-table">
                    ...
                    <div class="email-container">
                        ...
                        <p>Welcome to the EcoBizCheck CSR certification program for <xsl:value-of select="client/@company_name" />. You are 3 simple steps away from achieving certification:</p>
                        <ol>
                            <li>Assessment: <a href="https://www.ecobizcheck.com/members/">Registration</a> / <a href="https://www.ecobizcheck.com/members/">log-in here</a> to complete assessment</li>
                        ...
                        <p>We are delighted to welcome you to our CSR Certification Program and look forward to working with you and your team. Please feel free to contact us at <a href="mailto:info@ecobizcheck.com">info@ecobizcheck.com</a> at any time if you have any questions.</p>
