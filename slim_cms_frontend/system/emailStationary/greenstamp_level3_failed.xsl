...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/subject">Green Stamp Level 3 Failed</xsl:template>
	...
	<xsl:template match="/config">
		<html>
			<body>
				...
				<p>Unfortunately, <xsl:value-of select="client/@company_name" /> has failed to meet the Green Stamp criteria set out in Level 3 – Continual Improvement.</p>
				<p>For further assistance in achieving Level 3, please contact the MTA for a free and confidential environmental audit or to ask for industry related environmental advice.</p>
