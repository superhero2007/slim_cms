			...
			<body>            	
				<table class="background-table">
	                ...
	                <div class="email-container">
						...
						<p>It has been six months since your GreenBizCheck CSR certification expired and we would love to have you back.</p>
						<p>To demonstrate how much we want you back we are happy to offer you the <strong>full 3-year program at a 2-year price</strong> plus you will benefit from an upgraded, even more effective program.</p> 
						<p>We will be in touch in the next few days to discuss this option and how we can potentially help you maximise the benefits of your CSR program.</p>
