...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/subject">Green Stamp Level 2 Passed</xsl:template>
	...
	<xsl:template match="/config">
		<html>
			<body>
				...
				<!-- //Email Message -->
				<p>Thank you for participating in the MTA's Green Stamp Program. Your business has successfully passed Green Stamp Level 2 (Voluntary Initiatives). Congratulations!</p>
