...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/subject">Your GHG Tracking Assessment is waiting for you</xsl:template>
			...
			<body>            	
				<table class="background-table">
	                ...
	                <div class="email-container">
						...
						<p>Congratulations on completing your APC Site-Based Energy and Resource Assessment and Action Plan. We have now added an APC Greenhouse Gas tracking program to your client account.</p>
						<p>Please <a href="http://apc.greenbizcheck.com/members/">click here</a> and complete the relevant sections that you would like us to monitor.</p>
