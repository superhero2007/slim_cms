...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/subject">Payment Received - GreenBizCheck Online Certification</xsl:template>
			...
			<body>            	
				<table class="background-table">
	                ...
	                <div class="email-container">
						...
						<p>Simply login at <a href="https://www.greenbizcheck.com/members/">www.greenbizcheck.com</a>, select "My Account" in the top right hand corner and get started on your assessment.</p>
						<p>Please feel free to contact us at <a href="mailto:info@greenbizcheck.com">info@greenbizcheck.com</a> if you have any questions.</p>
