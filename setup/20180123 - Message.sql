...
CREATE TABLE `message_2_message_type` (
  `message_2_message_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `message_id` int(11) NOT NULL,
  `message_type_id` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`message_2_message_type_id`)
...
(1004, 943, 97, NULL, 0, 0, 'messages', '', 'Message List', 0, '0000-00-00', '', '', '', '', 1),
(1005, 1004, 97, NULL, 0, 0, 'create', '', 'Create Message', 0, '0000-00-00', '', '', '', '', 1),
(1006, 1004, 97, NULL, 0, 0, 'edit', '', 'Edit Message', 0, '0000-00-00', '', '', '', '', 1);
