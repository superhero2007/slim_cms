...
--
-- Table structure for table `client_2_client_role`
--

DROP TABLE IF EXISTS `client_2_client_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `client_2_client_role` (
  `client_2_client_role_id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `client_role_id` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`client_2_client_role_id`)
...
CREATE TABLE `client_role` (
  ...
  `client_role` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
